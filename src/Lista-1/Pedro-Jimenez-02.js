...
export default function Lista02() {
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.titulo}>Lista 02 - Pedro Jimenez</Text>

      <View style={styles.card}>
        <Text style={styles.label}>Exercício 1 — Operador Ternário</Text>
        <Text style={styles.texto}>Status: {loja_aberta ? "Logado" : "Deslogado"}</Text>
      </View>
      ...
      <View style={styles.card}>
        ...
        {!tem_promocao && <Text style={styles.texto}>"Promoção fora do ar."</Text>}
      </View>

       <View style={styles.card}>
        <Text style={styles.label}>Exercício 3 — Condicional com Múltiplas Condições</Text>
        <Text style={styles.texto}>Status: {calcNota(nota)}</Text>
      </View>
